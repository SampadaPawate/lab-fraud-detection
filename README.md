...
This project is currently maintained by Sampada Santosh Pavate.

Sampada is a results-driven Data Analyst with 3+ years of professional experience, skilled in leveraging SQL, Excel, and Python (Pandas, NumPy, Matplotlib) to extract insights, automate workflows, and support data-driven decision-making.
