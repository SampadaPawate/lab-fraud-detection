...
This project is actively maintained by Sampada Santosh Pavate. Sampada is a results-driven Data Analyst, combining analytical acumen with over 8 years of corporate experience in service delivery and process optimization. Skilled in leveraging SQL, Excel, and Python (Pandas, NumPy, Matplotlib) to extract insights, automate workflows, and support data-driven decision-making.
